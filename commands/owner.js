...
module.exports = {
  ...
  run: async (client, interaction) => {
    try {
      ...
      const RobloxLink = 'https://www.instagram.com/rtxxgg/';
      const { EmbedBuilder } = require('discord.js')
        const embed = new EmbedBuilder()
          ...
          url: 'https://discord.gg/FUEHs7RCqz'
            ...
            .setDescription(`__**About me**__:\n\n I am Boss, a fellow Discord user, who happened to have put this bot up online. : ❤️ [RTX GAMING](${youtubeLink})\n Roblox : 💙 [rtxxgg](${RobloxLink})`)
            .setTimestamp();
